...
namespace arpitlearnsmobileapp
{
    ...
    public class ToDoActivity : Activity
    {
        ...
        const string applicationURL = @"https://arpitlearnsmobileapp.azurewebsites.net";
        ...
        protected override async void OnCreate(Bundle bundle)
        {
            ...
            var uri = new Uri(@"https://arpitlearnsmobileapp.azurewebsites.net");
